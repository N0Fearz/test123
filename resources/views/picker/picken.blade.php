        ...
        <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 pr-10 lg:px-8">
            <div
                ...
                <div class="flex justify-between">
                    <a href=""
                        class="order-last bg-transparent hover:bg-blue text-blue-dark font-semibold hover:text-grey py-2 px-4 border border-blue rounded w-1/4 justify-center text-center">Bestelling
                        afronden</a>
