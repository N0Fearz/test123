        ...
        <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 pr-10 lg:px-8">
            <div
                ...
                <div class="flex justify-between">
                    <div class="inline-flex border rounded w-1/4 px-2 lg:px-6 h-12 bg-transparent">
            ...
            <div
                    ...
                    <tbody class="bg-white">
                        @foreach ($orders as $order)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-500">
                                    <div class="text-sm leading-5 text-blue-900">{{ $order->customer->company_name }}
                                    </div>
                                </td>
                                <td
                                ...
                                <td class="px-6 py-4  border-b text-blue-900 border-gray-500 text-sm leading-5">
                                    <a class="bg-transparent hover:bg-blue text-blue-dark font-semibold hover:text-grey py-2 px-4 border border-blue rounded"
                                        href="{{ route('order_verkoop', $order->id) }}">
                                        Bekijken
                                    </a>
                                </td>
                            </tr>
                ...
                <div class="sm:flex-1 sm:flex sm:items-center sm:justify-between mt-4 work-sans">
                    <a href="{{ route('add_order') }}"
                        class="my-4 bg-transparent hover:bg-blue text-blue-dark font-semibold hover:text-grey py-2 px-4 border border-blue rounded w-1/4 justify-center text-center">Bestelling
                        toevoegen</a>
                </div>
            </div>
        </div>
